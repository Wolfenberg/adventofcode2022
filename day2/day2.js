...
const myScoreForRound = (opponent, me) => {
    // draw
    if (opponent === me) {
        return 3
    }
    // me lost
    if (isRightLost(opponent, me)) {
        return 0
    }
    // opponent lost
    if (isRightLost(me, opponent)) {
        return 6
    }
}

const isRightLost = (left, right) => {
    // lost
    if (left === 'rock' && right === 'siss') {
        return true
    }
    // lost
